...
public class CalibrationProjectHandler {
    ...
    public static void saveCalibration(File file, Calibration calibration) throws IOException {
    ...
    public static void saveCalibrationProject(File file, UIController controller) throws IOException {        
        CalibrationProjectHandler pHandler = new CalibrationProjectHandler();
    ...
    public static void loadCalibrationProject(File file, UIController controller) throws ClassNotFoundException, IOException {    	
	...
	public static Project loadProjectData(File file) throws IOException, ClassNotFoundException {    	
     ...
     * @throws IOException 
     */
    public static void unZipIt(String zipFile, String outputFolder, UIController controller) throws IOException {
